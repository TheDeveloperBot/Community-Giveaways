class Giveaway {
    ...
    async intervalFunction() {
        ...
        if(Date.now() >= this.endTime){
            ...
            if (this.winners.length) this.msg.channel.send(`Congratulations, ${this.winners.map(u => u.toString()).join(", ")}! You won the giveaway for **${this.title}**! <:giveaway:468913345832157185>`);
        }
